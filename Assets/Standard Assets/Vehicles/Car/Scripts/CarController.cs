...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    {
        [SerializeField] private bool enableFX;
        ...
        public Vector3 LocalAngularVelocity => transform.InverseTransformVector(m_Rigidbody.angularVelocity);
        public Vector3 Inclination => new Vector3(transform.right.y, transform.up.y, transform.forward.y);
        public float NormalizedSteerAngle => m_SteerAngle / m_MaximumSteerAngle;
